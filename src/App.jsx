        ...
        <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 animate-on-scroll animate-slide-up">
                ...
                <div id="filter-buttons" className="flex flex-wrap justify-center gap-3 mt-8">
                    ...
                    <button onClick={() => setProjectFilter('fullstack')} className={`filter-btn px-6 py-2 rounded-full font-medium transition-all shadow-sm ${projectFilter === 'fullstack' ? 'bg-gray-900 text-white' : 'bg-white text-gray-700 border border-gray-200 hover:bg-gray-100'}`}>Full-stack</button>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-white">duyn3630@gmail.com</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-white">0971610978</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-white">Bình Tân, Tp.HCM</p>
                            </div>
                        </div>
                    </div>
                </div>
                      ...
                      <div id="contact-content">
                          <form className="space-y-6" onSubmit={handleContactSubmit}>
                              ...
                              <div>
                                  ...
                                  <input type="email" name="email" required className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all" placeholder="your@email.com" />
                              </div>
                              <div>
                                  <label className="block text-sm font-medium text-gray-700 mb-2">Message</label>
                                  <textarea name="message" required className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all h-32" placeholder="Your message..."></textarea>
                              </div>
